                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="farmer_contact">Farmer Contact <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-farmer_contact"  value="<?php  echo $data['farmer_contact']; ?>" type="text" placeholder="Enter Farmer Contact"  required="" name="farmer_contact"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-national_id"  value="<?php  echo $data['national_id']; ?>" type="text" placeholder="Enter National Id"  required="" name="national_id"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-county"  value="<?php  echo $data['county']; ?>" type="text" placeholder="Enter County"  required="" name="county"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
