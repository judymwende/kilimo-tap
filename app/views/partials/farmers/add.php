                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-farmer_contact"  value="<?php  echo $this->set_field_value('farmer_contact',""); ?>" type="text" placeholder="Enter Farmer Contact"  required="" name="farmer_contact"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-county"  value="<?php  echo $this->set_field_value('county',""); ?>" type="text" placeholder="Enter County"  required="" name="county"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
